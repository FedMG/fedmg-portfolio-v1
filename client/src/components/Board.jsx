  ...
  return (
    <div className="about-board-container grid-center">
      <Carousel>
        <BoardContent>
          <Text>
            Self-taught Software Developer &#128187;, with more than a year and
            a half of experience with information technologies.
          </Text>
          <Text>
            I love meeting curious and passionate people, with whom there can be
            mutual learning that allows us to grow and improve.
          </Text>
          <Text>
        ...
        <BoardContent header="Soft-skills">
          ...
          <Text icon="&#x1F91D;" header="Team player attitude">
            I love to work side by side and help whoever needs it to achieve a
            common goal.
          </Text>
        </BoardContent>
      </Carousel>
